package net.cocotea.schedule.service.impl;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.lang.UUID;
import net.cocotea.common.enums.ActiveEnum;
import net.cocotea.common.enums.DeleteStatusEnum;
import net.cocotea.common.model.BusinessException;
import net.cocotea.schedule.entity.ScheduleJob;
import net.cocotea.schedule.param.ScheduleJobAddParam;
import net.cocotea.schedule.param.ScheduleJobPageParam;
import net.cocotea.schedule.param.ScheduleJobUpdateParam;
import net.cocotea.schedule.service.IScheduleJobRegistryService;
import net.cocotea.schedule.service.IScheduleJobService;
import net.cocotea.schedule.vo.ScheduleJobVO;
