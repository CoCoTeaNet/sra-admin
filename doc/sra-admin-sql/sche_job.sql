...
(
    ...
    comment '计划任务表' engine = InnoDB;

INSERT INTO DB_SRA_V1.sche_job (ID, NAME, TYPE, CLASS_NAME, METHOD_NAME, PARAMETERS, CORN_EXPRESSION, DESCRIPTION, ACTIVE, NEXT_EXE_TIME, CREATE_TIME, CREATE_BY, UPDATE_TIME, UPDATE_BY, DELETE_STATUS, REVISION, SORT) VALUES ('3d1f9250e1a74981acafbbe34b0fad3c', '文章内容爬取任务', 1, 'net.cocotea.admin.schedule.jobs.ContentSpider', 'test', '{"param":"this is params."}', '0/2 * * * * ?', 'testtesttesttest', 0, null, '2022-09-03 16:01:42', '7d7f2f72dd0e4b6080373a3cc1469a15', '2023-01-18 15:40:20', '7d7f2f72dd0e4b6080373a3cc1469a15', 1, null, 1);
INSERT INTO DB_SRA_V1.sche_job (ID, NAME, TYPE, CLASS_NAME, METHOD_NAME, PARAMETERS, CORN_EXPRESSION, DESCRIPTION, ACTIVE, NEXT_EXE_TIME, CREATE_TIME, CREATE_BY, UPDATE_TIME, UPDATE_BY, DELETE_STATUS, REVISION, SORT) VALUES ('906c407f7a1b47ca85a9b75b765f4742', '任务测试2123123', 1, 'net.cocotea.admin.schedule.jobs.MethodModeSample', 'run', '{"param":"123"}', '* * * * * ?', 'ojoaijdo', 0, null, '2022-09-03 09:32:15', '7d7f2f72dd0e4b6080373a3cc1469a15', '2023-01-18 15:39:36', '7d7f2f72dd0e4b6080373a3cc1469a15', 1, null, 1);
