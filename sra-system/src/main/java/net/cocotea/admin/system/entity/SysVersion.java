...
public class SysVersion implements Serializable {
    ...
    public SysVersion setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SysVersion setUpdateNo(String updateNo) {
    ...
    public SysVersion setUpdateDesc(String updateDesc) {
    ...
    public SysVersion setPlatformName(String platformName) {
    ...
    public SysVersion setCreateBy(String createBy) {
    ...
    public SysVersion setCreateTime(LocalDateTime createTime) {
    ...
    public SysVersion setUpdateBy(String updateBy) {
    ...
    public SysVersion setUpdateTime(LocalDateTime updateTime) {
