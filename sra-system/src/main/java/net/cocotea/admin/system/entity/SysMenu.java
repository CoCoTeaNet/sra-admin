...
public class SysMenu implements Serializable {
	...
	public SysMenu setRevision(Integer revision) {
	...
	public SysMenu setCreateBy(String createBy) {
	...
	public SysMenu setDeleteStatus(Integer deleteStatus) {
	...
	public SysMenu setPermissionCode(String permissionCode) {
	...
	public SysMenu setRouterPath(String routerPath) {
	...
	public SysMenu setIsMenu(Integer isMenu) {
		this.isMenu = isMenu;
		return this;
	}
	...
	public SysMenu setMenuStatus(Integer menuStatus) {
	...
	public SysMenu setComponentPath(String componentPath) {
	...
	public SysMenu setIsExternalLink(Integer isExternalLink) {
	...
	public SysMenu setIconPath(String iconPath) {
