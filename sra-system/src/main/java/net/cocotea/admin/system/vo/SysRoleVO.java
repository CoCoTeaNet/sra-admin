...
public class SysRoleVO implements Serializable {
	 ...
	 */
	public SysRoleVO setId(String id) {
		this.id=id;
		return this;
	}
	 ...
	 */
	public SysRoleVO setRevision(Integer revision) {
	 ...
	 */
	public SysRoleVO setCreateBy(String createBy) {
	 ...
	 */
	public SysRoleVO setCreateTime(LocalDateTime createTime) {
	 ...
	 */
	public SysRoleVO setUpdateBy(String updateBy) {
	 ...
	 */
	public SysRoleVO setUpdateTime(LocalDateTime updateTime) {
	 ...
	 */
	public SysRoleVO setDeleteStatus(String deleteStatus) {
	 ...
	 */
	public SysRoleVO setRoleKey(String roleKey) {
	 ...
	 */
	public SysRoleVO setSort(Integer sort) {
		this.sort=sort;
		return this;
	}
	 ...
	 */
	public SysRoleVO setRemark(String remark) {
		this.remark=remark;
		return this;
	}
