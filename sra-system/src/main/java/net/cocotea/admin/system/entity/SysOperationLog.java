...
public class SysOperationLog implements Serializable {
    ...
    public SysOperationLog setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SysOperationLog setLogNumber(Long logNumber) {
    ...
    public SysOperationLog setIpAddress(String ipAddress) {
    ...
    public SysOperationLog setOperator(String operator) {
    ...
    public SysOperationLog setRequestWay(String requestWay) {
    ...
    public SysOperationLog setOperationStatus(Integer operationStatus) {
    ...
    public SysOperationLog setSystemModule(String systemModule) {
    ...
    public SysOperationLog setOperationType(Integer operationType) {
    ...
    public SysOperationLog setOperationAddress(String operationAddress) {
    ...
    public SysOperationLog setLogType(String logType) {
    ...
    public SysOperationLog setOperationTime(LocalDateTime operationTime) {
