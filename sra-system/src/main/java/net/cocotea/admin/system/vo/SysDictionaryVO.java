...
public class SysDictionaryVO implements Serializable {
	...
	public List<SysDictionaryVO> getChildren() {
		return children;
	}

	public void setChildren(List<SysDictionaryVO> children) {
	...
	public SysDictionaryVO setEnableStatus(Integer enableStatus) {
