...
public class SysDictionary implements Serializable {
	...
	public SysDictionary setParentId(String parentId) {
	...
	public SysDictionary setDictionaryName(String dictionaryName) {
	...
	public SysDictionary setRemark(String remark) {
		this.remark = remark;
		return this;
	}
	...
	public SysDictionary setSort(Integer sort) {
		this.sort = sort;
		return this;
	}
	...
	public SysDictionary setEnableStatus(Integer enableStatus) {
	...
	public SysDictionary setRevision(Integer revision) {
	...
	public SysDictionary setCreateBy(String createBy) {
	...
	public SysDictionary setCreateTime(LocalDateTime createTime) {
	...
	public SysDictionary setUpdateBy(String updateBy) {
	...
	public SysDictionary setUpdateTime(LocalDateTime updateTime) {
	...
	public SysDictionary setDeleteStatus(Integer deleteStatus) {
