...
public class SysUser implements Serializable {
	...
	public SysUser setRevision(Integer revision) {
	...
	public SysUser setDeleteStatus(Integer deleteStatus) {
	...
	public SysUser setMobilePhone(String mobilePhone) {
	...
	public SysUser setDepartmentId(String departmentId) {
	...
	public SysUser setAccountStatus(Integer accountStatus) {
	...
	public SysUser setLastLoginTime(LocalDateTime lastLoginTime) {
